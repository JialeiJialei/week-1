...
class Player:
    ...
    def __init__(self, inputID, startingPot):
      ...
      self.playerpotmoney=startingPot
...
def checkBalances(players):
  ...
  print 'player'+str(player.playerid)+' has $' + str(player.playerpotmoney) + ' left'
